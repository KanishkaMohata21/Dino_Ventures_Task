    ...
    extend: {
      ...
      colors: {
        ...
        category: {
          ...
          ocean: "hsl(var(--category-ocean))",
          urban: "hsl(var(--category-urban))",
          abstract: "hsl(var(--category-abstract))",
      ...
      animation: {
        ...
        "skip-feedback": "skip-feedback 0.6s ease-out forwards",
      },
    },
  },
